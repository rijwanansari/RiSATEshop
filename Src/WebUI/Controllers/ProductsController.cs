...
using RiSAT.Eshop.Application.Products.Commands.CreateProduct;
using RiSAT.Eshop.Application.Products.Commands.DeleteProduct;
using RiSAT.Eshop.Application.Products.Commands.UpdateProduct;
...
namespace RiSAT.Eshop.WebUI.Controllers
{
    [Authorize]

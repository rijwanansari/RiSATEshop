...
namespace RiSAT.Eshop.Application.Employees.Commands.DeleteEmployee
{
    public class DeleteEmployeeCommand : IRequest
    {
        ...
        public class DeleteEmployeeCommandHandler : IRequestHandler<DeleteEmployeeCommand>
        {
            ...
            public DeleteEmployeeCommandHandler(IRiSATeshopDbContext context, IUserManager userManager, ICurrentUserService currentUser)
            {
                _context = context;
